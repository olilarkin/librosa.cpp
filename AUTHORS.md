...
* Oli Larkin <https://github.com/olilarkin>

## Original librosa contributors

librosa.cpp is a C++17 port of [librosa](https://github.com/librosa/librosa).
The contributor list below is reproduced verbatim from the upstream project's
`AUTHORS.md`. All algorithmic credit belongs to these authors.
